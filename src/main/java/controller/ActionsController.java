	...
	public void handleRequest(HttpServletRequest request, HttpServletResponse response) {
		...
		if (posSoldier != null && posSoldier != "") {
			...
			if (action.equals("top")) {
				this.actionMove(posSoldierX, posSoldierY, posSoldierX - 1, posSoldierY, idPlayer, map, request,
						response);
			} else if (action.equals("bottom")) {
				this.actionMove(posSoldierX, posSoldierY, posSoldierX + 1, posSoldierY, idPlayer, map, request,
						response);
			} else if (action.equals("right")) {
				this.actionMove(posSoldierX, posSoldierY, posSoldierX, posSoldierY - 1, idPlayer, map, request,
						response);
